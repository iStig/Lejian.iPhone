...
static const CGFloat kDefaultPageSpacing = 0.0f;
...
- (id)initWithFrame:(CGRect)frame {
  ...
  if (self) {
    ...
    _centerPageAnimationDuration = 0.3f;
...
//    NSLog(@"TOP:%f,left:%f,boom:%f,right:%f",newEdges.top,newEdges.left,newEdges.bottom,newEdges.right);
  return newEdges;
}
    ...
    for (UITouch* touch in touches) {
      ...
      if (_touchCount == 1) {
        ...
        if (_scrollEnabled && !_holding) {
          ...
          _pageStartEdges  = _pageEdges;//初始全为0
//            NSLog(@"pageBegin一只手:%f,left:%f,boom:%f,right:%f",_touchStartEdges.top,_touchStartEdges.left,_touchStartEdges.bottom,_touchStartEdges.right);
        ...
        if (_scrollEnabled && !_holding) {
          ...
          _pageStartEdges = _pageEdges;
//            NSLog(@"pageBegin2只手:%f,left:%f,boom:%f,right:%f",_touchStartEdges.top,_touchStartEdges.left,_touchStartEdges.bottom,_touchStartEdges.right);
...
//   NSLog(@"top111111:%f,left11111:%f,boom111111:%f,right111111:%f",top,left,bottom,right);
