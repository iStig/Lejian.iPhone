 ...
 *        loadDataSource: callback message as soon as the appplication data
 ...
 *        after you issue the loadDataSource: callback message
...
- (void)loadDataSource:(id<KalDataSource>)dataSource;
@end
