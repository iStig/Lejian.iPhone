...
@class KalGridView, KalLogic, KalDate, KalTileView;
...
//this 2 method is only for contentView animation by gongxuehan
...
//- (void)startOfDetailViewAnimate:(CGPoint)point;
